...
def search_income(request):
    """
    Search for income entries based on various fields.
    """
...
def income_category_summary(request):
    """
    Summarize income by category and return as JSON.
    """
