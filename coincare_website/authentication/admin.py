...
using a custom form for user creation and change.
"""
...
class UserAdmin(BaseUserAdmin):
    ...
    This class customizes the admin interface for the User model to use
    a custom form and adjust the display and filtering options.
    """
